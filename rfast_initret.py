...
if len(sys.argv) >= 3:
    ...
    # otherwise ask for filename
    filename_ret = input("rfast retrieved parameters filename: ")
...
targeta1 = targetg1
if clr:
    targeta1 = targetg1.replace("xi", "lf").replace(
        "/gx", "").replace("log", "log10")
targeta2 = targetg2
